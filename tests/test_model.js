...
assert.strictEqual(Model.barLabel(41), "41%")
assert.strictEqual(Model.barLabel(99), "99%")
assert.strictEqual(Model.barLabel(-3), "0%")
assert.strictEqual(Model.packPercent(0.41, 10), 41)
assert.strictEqual(Model.packPercent(0.19, 80), 19)
assert.strictEqual(Model.packPercent(78, 10), 78)
assert.strictEqual(Model.packPercent(undefined, 41), 41)
assert.strictEqual(Model.barLabel(Model.packPercent(0.19, 80)), "19%")
